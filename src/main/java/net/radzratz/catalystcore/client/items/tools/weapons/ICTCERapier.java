...
public class ICTCERapier extends SwordItem implements ICTCEItem
{
    public ICTCERapier(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
