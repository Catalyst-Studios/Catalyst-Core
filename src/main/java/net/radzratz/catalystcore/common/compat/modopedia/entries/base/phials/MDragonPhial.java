...
{
    public static void registerDragonBloodPhial(HolderLookup.Provider registries, BookContentOutput output)
    {
        EntryBuilder.of("Dragon's Blood")
                ...
                .build("phials/dragon_blood", output);
    }
}
