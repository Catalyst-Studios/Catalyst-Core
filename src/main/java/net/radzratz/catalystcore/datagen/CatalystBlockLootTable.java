...
public class CatalystBlockLootTable extends BlockLootSubProvider
{
    protected CatalystBlockLootTable(HolderLookup.Provider registries)
    {
    ...
    {
        return CatalystBlocks.BLOCKS.getEntries().stream().map(Holder::value)::iterator;
    }
