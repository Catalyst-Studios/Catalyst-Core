...
public class ICTCEBroadSword extends SwordItem implements ICTCEItem
{
    public ICTCEBroadSword(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
