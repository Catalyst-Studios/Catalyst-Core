...
public class CatalystAltarPedestal extends BaseEntityBlock
{
    public static final VoxelShape SHAPE = Block.box(2,0,2,14,10,14);

    public static final MapCodec<CatalystAltarPedestal> CODEC = simpleCodec(CatalystAltarPedestal::new);

    public CatalystAltarPedestal(Properties properties)
    {
        super(properties);
    }
