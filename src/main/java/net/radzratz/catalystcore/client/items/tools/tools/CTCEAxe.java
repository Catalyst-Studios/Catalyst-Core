...
public class CTCEAxe extends AxeItem implements ICTCEItem
{
    public CTCEAxe(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
