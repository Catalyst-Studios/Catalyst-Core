...
public class CatalystGreatSword extends SwordItem implements CatalystItemInterface
{
    public CatalystGreatSword(Tier tier, Item.Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
    ...
    {
        tooltip.add(Component.translatable("item.catalystcore.cataclystic_greatsword.desc").withStyle(ChatFormatting.DARK_BLUE));
