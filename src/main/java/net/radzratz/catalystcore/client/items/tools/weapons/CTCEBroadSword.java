...
public class CTCEBroadSword extends SwordItem implements ICTCEItem
{
    public CTCEBroadSword(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
