...
public class ICTCEGladius extends SwordItem implements ICTCEItem
{
    public ICTCEGladius(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
