...
public class ICTCEBattleAxe extends AxeItem implements ICTCEItem
{
    public ICTCEBattleAxe(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
