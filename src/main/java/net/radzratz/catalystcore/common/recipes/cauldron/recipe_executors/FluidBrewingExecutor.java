...
public class FluidBrewingExecutor
{
    public static boolean tickFluidBrewing(CatalystCauldronBlockEntity be, Level level)
    {
        ...
        Optional<RecipeHolder<FluidBrewingRecipeType>> recipeOpt = level.getRecipeManager()
        ...
        FluidBrewingRecipeType recipe = recipeOpt.get().value();
