...
public class CTCEZweihander extends SwordItem implements ICTCEItem
{
    public CTCEZweihander(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
