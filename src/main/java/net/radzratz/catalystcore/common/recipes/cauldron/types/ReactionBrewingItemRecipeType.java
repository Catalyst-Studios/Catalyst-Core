...
public abstract class ReactionBrewingItemRecipeType implements Recipe<CauldronInput>
{
    ...
    public ReactionBrewingItemRecipeType(List<Ingredient> orderedIngredients,
                                         ItemStack result,
                                         int fluidAmount,
                                         int cookingTime,
