...
public class CatalystBattleAxe extends AxeItem implements CatalystItemInterface
{
    public CatalystBattleAxe(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
    ...
    {
        tooltip.add(Component.translatable("item.catalystcore.cataclystic_battleaxe.desc").withStyle(ChatFormatting.DARK_BLUE));
