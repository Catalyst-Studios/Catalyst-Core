...
public class CatalystAxe extends AxeItem implements CatalystItemInterface
{
    public CatalystAxe(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
