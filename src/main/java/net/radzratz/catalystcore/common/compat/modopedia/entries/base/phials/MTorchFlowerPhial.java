...
{
    public static void registerTorchFlowerPhial(HolderLookup.Provider registries, BookContentOutput output)
    {
        EntryBuilder.of("TorchFlower Essence")
                ...
                .build("phials/torch_flower_essence", output);
    }
}
