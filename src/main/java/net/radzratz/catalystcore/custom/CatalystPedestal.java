...
public class CatalystPedestal extends BaseEntityBlock
{
    public static final VoxelShape SHAPE = Block.box(2,0,2,14,13,14);

    public static final MapCodec<CatalystPedestal> CODEC = simpleCodec(CatalystPedestal::new);

    public CatalystPedestal(Properties properties)
    {
        super(properties);
    }
    ...
    {
        return new CatalystPedestalEntity(blockPos, blockState);
    }
    ...
    protected void onRemove(BlockState state, @NotNull Level level, @NotNull BlockPos pos, BlockState newState, boolean movedByPiston)
    {
        ...
        {
            if(level.getBlockEntity(pos) instanceof CatalystPedestalEntity pedestalBlockEntity)
            {
    ...
    {
        if(level.getBlockEntity(pos) instanceof CatalystPedestalEntity pedestalEntity)
        {
