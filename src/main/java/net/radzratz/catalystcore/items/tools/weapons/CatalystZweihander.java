...
public class CatalystZweihander extends SwordItem implements CatalystItemInterface
{
    public CatalystZweihander(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
    ...
    {
        tooltip.add(Component.translatable("item.catalystcore.cataclystic_zweihander.desc").withStyle(ChatFormatting.DARK_BLUE));
