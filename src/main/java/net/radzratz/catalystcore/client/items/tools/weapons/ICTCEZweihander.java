...
public class ICTCEZweihander extends SwordItem implements ICTCEItem
{
    public ICTCEZweihander(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
