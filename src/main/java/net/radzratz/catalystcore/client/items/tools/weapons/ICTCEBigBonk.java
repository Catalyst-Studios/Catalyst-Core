...
public class ICTCEBigBonk extends SwordItem implements ICTCEItem
{
    public ICTCEBigBonk(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
