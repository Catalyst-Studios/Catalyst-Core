...
public class CTCERapier extends SwordItem implements ICTCEItem
{
    public CTCERapier(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
