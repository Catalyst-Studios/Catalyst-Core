...
public class CatalystGladius extends SwordItem implements CatalystItemInterface
{
    public CatalystGladius(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
    ...
    {
        tooltip.add(Component.translatable("item.catalystcore.cataclystic_gladius.desc").withStyle(ChatFormatting.DARK_BLUE));
