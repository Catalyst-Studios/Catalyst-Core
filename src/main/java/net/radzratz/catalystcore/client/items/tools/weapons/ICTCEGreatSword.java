...
public class ICTCEGreatSword extends SwordItem implements ICTCEItem
{
    public ICTCEGreatSword(Tier tier, Item.Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
