package net.radzratz.catalystcore.ponder.phials;
...
import static net.radzratz.catalystcore.items.CatalystItems.REINFORCED_BOTTLE;
import static net.radzratz.catalystcore.items.CatalystItems.TORCHFLOWER_BOTTLE;
