...
public class ICTCEShovel extends ShovelItem implements ICTCEItem
{
    public ICTCEShovel(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
