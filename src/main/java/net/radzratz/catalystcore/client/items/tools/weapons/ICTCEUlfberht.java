...
public class ICTCEUlfberht extends SwordItem implements ICTCEItem
{
    public ICTCEUlfberht(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
