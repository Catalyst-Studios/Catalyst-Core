...
public class PaxelRegistry extends DiggerItem {
    ...
    static {
        ...
        FLATTENABLES.put(Blocks.DIRT_PATH, Blocks.FARMLAND.defaultBlockState());
    }
    ...
    protected Optional<BlockState> evaluateNewBlockState(Level level, BlockPos pos, @Nullable Player player, BlockState state, UseOnContext context) {
