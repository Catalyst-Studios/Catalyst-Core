...
import net.radzratz.catalystcore.client.items.tools.tools.custom.PaxelRegistry;
...
public class ICTCEPaxel extends PaxelRegistry implements ICTCEItem
{
    public ICTCEPaxel(Tier tier, Item.Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
