...
public class CTCEHammer extends SwordItem implements ICTCEItem
{
    public CTCEHammer(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
