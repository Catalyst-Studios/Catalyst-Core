...
import static net.radzratz.catalystcore.common.recipes.cauldron.util.helper.CauldronExecutorHelpers.performCraftWaterBrewing;

public class WaterBrewingExecutor
{
    public static boolean tickWaterBrewing(CatalystCauldronBlockEntity be, Level level)
    {
        ...
        Optional<RecipeHolder<WaterBrewingRecipeType>> recipeOpt = level.getRecipeManager()
                .getRecipeFor(CTCERecipeTypes.WATER_BREWING.get(), inputs, level);
        ...
        WaterBrewingRecipeType recipe = recipeOpt.get().value();
        ...
        {
            performCraftWaterBrewing(recipe, be, level);
        }
