...
public class CTCEBattleAxe extends AxeItem implements ICTCEItem
{
    public CTCEBattleAxe(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
