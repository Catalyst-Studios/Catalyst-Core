package net.radzratz.catalystcore.client.items.foods;

import net.minecraft.world.effect.MobEffectInstance;
import net.minecraft.world.effect.MobEffects;
import net.minecraft.world.food.FoodProperties;

public class CTCEFoods {
    public static final FoodProperties BURRITO = new FoodProperties.Builder().nutrition(7).saturationModifier(4.5f)
