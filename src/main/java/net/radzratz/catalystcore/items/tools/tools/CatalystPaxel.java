...
import net.radzratz.catalystcore.items.tools.tools.custom.PaxelRegistry;
...
public class CatalystPaxel extends PaxelRegistry implements CatalystItemInterface
{
    public CatalystPaxel(Tier tier, Item.Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
