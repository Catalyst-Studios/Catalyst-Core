...
public class CatalystRapier extends SwordItem implements CatalystItemInterface
{
    public CatalystRapier(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
    ...
    {
        tooltip.add(Component.translatable("item.catalystcore.cataclystic_rapier.desc").withStyle(ChatFormatting.DARK_BLUE));
