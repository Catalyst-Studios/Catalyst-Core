...
public class ICTCEScythe extends SwordItem implements ICTCEItem
{
    public ICTCEScythe(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
