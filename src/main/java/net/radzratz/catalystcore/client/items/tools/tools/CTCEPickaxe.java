...
public class CTCEPickaxe extends PickaxeItem implements ICTCEItem
{
    public CTCEPickaxe(Tier tier, Item.Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
