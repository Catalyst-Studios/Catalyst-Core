...
public class CatalystCurioCompatibility
{
        ...
        event.registerItem(
                ...
                (stack, context) -> new ICurio()
                {
                    ...
                    private static final List<CatalystCurioEffect> EFFECT_CONFIGS = List.of(
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystNightVision::isTrue, 0),
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystDamageBoost::isTrue, 4),
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystMovementSpeed::isTrue, 2),
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystSaturation::isTrue, 0),
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystWaterBreathing::isTrue, 0),
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystLuck::isTrue, 4),
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystHealthBoost::isTrue, 4),
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystFireResistance::isTrue, 0),
                            new CatalystCurioEffect(CatalystConfig.CONFIG.curioCompatibility.catalystRegeneration::isTrue, 4)
                    );
                    ...
                    public void curioTick(SlotContext slotContext)
                    {
                        ...
                        if(!entity.level().isClientSide() && CatalystConfig.CONFIG.curioCompatibility.catalystCurioEffects.get())
                        {
