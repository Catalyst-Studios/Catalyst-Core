...
public class CTCEScythe extends SwordItem implements ICTCEItem
{
    public CTCEScythe(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
