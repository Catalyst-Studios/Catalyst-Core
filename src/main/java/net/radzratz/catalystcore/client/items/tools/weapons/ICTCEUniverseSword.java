...
public class ICTCEUniverseSword extends SwordItem implements ICTCEItem
{
    public ICTCEUniverseSword(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
