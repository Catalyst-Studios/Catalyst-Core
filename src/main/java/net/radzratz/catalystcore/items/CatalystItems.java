...
import net.radzratz.catalystcore.items.custom.PentagramItem;
import net.radzratz.catalystcore.items.tools.tools.CatalystPaxel;

import static net.radzratz.catalystcore.items.CatalystItemHelpers.*;
...
public class CatalystItems
{
    ...
    public static final DeferredItem<Item> ANTIMATTER = registerCatalystCoreEndGameItems("antimatter_cell");
