...
public class ICTCEPickaxe extends PickaxeItem implements ICTCEItem
{
    public ICTCEPickaxe(Tier tier, Item.Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
