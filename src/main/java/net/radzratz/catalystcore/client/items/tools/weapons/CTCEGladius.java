...
public class CTCEGladius extends SwordItem implements ICTCEItem
{
    public CTCEGladius(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
