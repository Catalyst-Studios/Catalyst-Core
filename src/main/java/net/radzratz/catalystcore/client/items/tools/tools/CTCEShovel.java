...
public class CTCEShovel extends ShovelItem implements ICTCEItem
{
    public CTCEShovel(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
