...
public class CTCEGreatSword extends SwordItem implements ICTCEItem
{
    public CTCEGreatSword(Tier tier, Item.Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
