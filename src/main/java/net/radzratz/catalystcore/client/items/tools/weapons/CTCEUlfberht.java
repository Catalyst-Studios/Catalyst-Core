...
public class CTCEUlfberht extends SwordItem implements ICTCEItem
{
    public CTCEUlfberht(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
