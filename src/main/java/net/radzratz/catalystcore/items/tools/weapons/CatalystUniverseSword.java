...
public class CatalystUniverseSword extends SwordItem implements CatalystItemInterface
{
    public CatalystUniverseSword(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
