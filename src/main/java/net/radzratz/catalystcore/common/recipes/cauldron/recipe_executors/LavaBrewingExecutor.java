...
public class LavaBrewingExecutor
{
    public static boolean tickLavaBrewing(CatalystCauldronBlockEntity be, Level level)
    {
        ...
        Optional<RecipeHolder<LavaBrewingRecipeType>> recipeOpt = level.getRecipeManager()
        ...
        LavaBrewingRecipeType recipe = recipeOpt.get().value();
