...
public class CTCEHalberd extends SwordItem implements ICTCEItem
{
    public CTCEHalberd(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
