...
public class CatalystUlfberht extends SwordItem implements CatalystItemInterface
{
    public CatalystUlfberht(Tier tier, Properties properties, Tool toolComponentData, ItemAttributeModifiers attributes)
    {
    ...
    {
        tooltip.add(Component.translatable("item.catalystcore.cataclystic_ulfberht.desc").withStyle(ChatFormatting.DARK_BLUE));
